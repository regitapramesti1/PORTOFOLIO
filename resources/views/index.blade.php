...
<body>
  ...
  <section id="hero" class="d-flex flex-column justify-content-center align-items-center">
    <div class="hero-container" data-aos="fade-in">
      <h1> REGITA CAHYANI<br> AYU PRAMESTI</h1>
      <p>I'm <span class="typed" data-typed-items="Student, Love sunset all the time, Photographer"></span></p>
    </div>
  </section><!-- End Hero -->
    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="section-title">
          <h2>About</h2>
          <p>i'm Regita Cahyani Ayu Pramesti, Welcome to my Portfolio. I invite you to Explore my site to get a better understanding of my specialties, Technique and Professional Experience. What you’ll find below is a Combination of commissioned Work, as well as some Personal Passion Projects, and Artworks of my own. </p>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
            ...
            <p class="fst-italic">
            Before looking into more details, I will introduce myself first
            </p>
            <div class="row">
              <div class="col-lg-6">
                <ul>
                  <li><i class="bi bi-chevron-right"></i> <strong>Birthday:</strong> <span>27 March 2007</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Phone:</strong> <span>+62 857 9036 0797</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>City:</strong> <span>Bojonegoro, Jawa Timur</span></li>
                </ul>
              </div>
              <div class="col-lg-6">
                <ul>
                  <li><i class="bi bi-chevron-right"></i> <strong>Age:</strong> <span>16</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Email:</strong><span>cahyaniregita623@gmail.com</span></li>
        ...
        <div class="row">
          <div class="col-lg-6" data-aos="fade-up">
            ...
            <div class="resume-item">
              <h4>TK Dharma Wanita Ngurah Rai</h4>
              <h5>2011 - 2013</h5>
              <p><em>coincides in Kabalan village, Bojonegoro</em></p>
              <h4>SDN Kabalan</h4>
              <h5>2013 - 2019</h5>
              <p><em>in the same place in Kabalan village, Bojonegoro</em></p>
              <h4>SMPN 1 Kanor</h4>
              <h5>2019 - 2022</h5>
              <p><em>Located in Kanor District, Bojonegoro</em></p>
              <h4>SMK Telkom Sidoarjo</h4>
              <h5>2022 - 2025</h5>
              <p><em>Located in Sekardangan District, Sidoarjo</em></p>
